...
package xyz.canardoux.mi_corazon;
 ...
 */
public class MiCorazonApp extends android.app.Application {
	/** Called when your application has started. */
	@Override
	public void onCreate() {
		super.onCreate();
		// Set up a Corona runtime listener used to add custom APIs to Lua.
		com.ansca.corona.CoronaEnvironment.addRuntimeListener(new MiCorazonApp.CoronaRuntimeEventHandler());
	}
